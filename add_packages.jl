...
Pkg.add(PackageSpec(name="TrajectoryOptimization", rev="split"))
Pkg.add(PackageSpec(name="TrajOptPlots", url="https://github.com/RoboticExplorationLab/TrajOptPlots.jl.git"))
